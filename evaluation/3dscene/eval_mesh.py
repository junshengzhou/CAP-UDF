...
def evaluate_mesh(gt_path, es_path, gt_points, n_points=1000000, normalize=False):
    es_mesh = trimesh.load_mesh(es_path)
    es_mesh = remove_far(gt_points, es_mesh, 0.008)
    ...
    result=evaluator.eval_mesh(es_mesh, gt_pointcloud, gt_normals)
...
if __name__ == '__main__':
    ...
    evaluate_mesh(gt_file, pred_file, np.load(input_file), 1000000)